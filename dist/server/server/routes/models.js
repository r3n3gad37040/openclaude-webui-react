...
import { getAllProviders, getConfiguredModels, getModelsByProvider, getCurrentPrimaryModel, getAllProviderKeys, setProviderApiKey, } from '../services/config.js';
...
router.get('/provider_keys', (c) => {
    ...
    const masked = Object.fromEntries(Object.entries(keys).map(([p, k]) => [
        p,
